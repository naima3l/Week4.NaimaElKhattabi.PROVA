...
namespace Week4.NaimaElKhattabi.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //{
            //    c.SwaggerDoc("v1", new OpenApiInfo { Title = "Week4.NaimaElKhattabi.API", Version = "v1" });
            //});

            //DI
            services.AddTransient<IMainBL, MainBL>(); //bl
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                //app.UseSwagger();
                //app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Week4.NaimaElKhattabi.API v1"));
            }
